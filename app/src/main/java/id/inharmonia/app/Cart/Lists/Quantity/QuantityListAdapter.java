...
public class QuantityListAdapter extends RecyclerView.Adapter<QuantityListAdapter.QuantityListViewHolder> {
    ...
    @NonNull
    @Override
    public QuantityListAdapter.QuantityListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(mLayoutType, parent, false);
        return new QuantityListAdapter.QuantityListViewHolder(mView);
    }

    @Override
    public void onBindViewHolder(@NonNull QuantityListAdapter.QuantityListViewHolder holder, int position) {
