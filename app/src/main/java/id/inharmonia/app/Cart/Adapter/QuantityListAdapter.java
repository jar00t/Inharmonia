...
public class QuantityListAdapter extends RecyclerView.Adapter<QuantityListAdapter.Holder> {
    ...
    @NonNull
    @Override
    public QuantityListAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(layout_type, parent, false);
        return new QuantityListAdapter.Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull QuantityListAdapter.Holder holder, int position) {
