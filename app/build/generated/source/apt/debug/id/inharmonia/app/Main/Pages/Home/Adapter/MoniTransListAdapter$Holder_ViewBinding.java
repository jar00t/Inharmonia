...
public class MoniTransListAdapter$Holder_ViewBinding implements Unbinder {
  private MoniTransListAdapter.Holder target;

  private View view2131296325;

  @UiThread
  public MoniTransListAdapter$Holder_ViewBinding(final MoniTransListAdapter.Holder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MoniTransListAdapter.Holder target = this.target;
