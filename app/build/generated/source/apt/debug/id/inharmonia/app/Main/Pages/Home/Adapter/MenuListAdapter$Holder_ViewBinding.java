...
public class MenuListAdapter$Holder_ViewBinding implements Unbinder {
  ...
  public MenuListAdapter$Holder_ViewBinding(final MenuListAdapter.Holder target, View source) {
    ...
    view = Utils.findRequiredView(source, R.id.cv_item_type, "field 'cv_item_menu' and method 'go_to'");
    target.cv_item_menu = Utils.castView(view, R.id.cv_item_type, "field 'cv_item_menu'", CardView.class);
    view2131296324 = view;
